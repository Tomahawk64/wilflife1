...
export default function AboutSection({ data }: AboutSectionProps) {
  ...
  return (
    <section id="about" ref={sectionRef} className="relative bg-warm-black overflow-hidden py-32 md:py-48">
      {/* Deep ambient bg */}
      <div className="absolute inset-0 pointer-events-none">
        <Image src="/media/giant-male-elephant-at-sunse.webp" alt="" fill
          className="object-cover object-center opacity-[0.06]" sizes="100vw" aria-hidden="true" />
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 70% 60% at 60% 50%, rgba(45,74,45,0.08) 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="grid md:grid-cols-12 gap-16 md:gap-0 items-start">
          ...
          {/* Portrait — spans 5 cols, bleeds left */}
          <motion.div
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-transparent to-warm-black/20" />
            </div>

            {/* Floating caption */}
            <div className="absolute -right-4 md:-right-8 bottom-24 flex flex-col items-end gap-2">
              <div className="w-8 h-px bg-evening-orange/50" />
              <p className="font-editorial italic text-sand/35 text-xs tracking-widest"
            ...
            {/* Left accent */}
            <div className="absolute -left-4 top-16 bottom-16 w-px bg-gradient-to-b from-transparent via-evening-orange/25 to-transparent" />
          </motion.div>
          ...
          <div className="md:col-span-6 md:col-start-7 flex flex-col gap-12 md:pt-16">
            <motion.div custom={2} variants={fadeUp} initial="hidden" animate={inView ? 'visible' : 'hidden'}>
              <h2 className="font-editorial font-light text-ivory leading-tight mb-8"
                style={{ fontSize: 'clamp(2.8rem, 5.5vw, 5rem)' }}>
                {data?.heading ?? <>The Eye<br />Behind<br /><em>the Frame</em></>}
              </h2>
              <div className="w-10 h-px bg-evening-orange/50 mb-8" />
              <p className="font-sans font-light text-sand/75 leading-relaxed text-base md:text-lg">
                {data?.bio ??
              ...
              <p className="font-sans font-light text-sand/50 leading-relaxed text-base mt-5">
                His philosophy is simple: <em className="text-sand/70 font-normal">patience is the lens</em>. Every frame 
            ...
            <motion.blockquote
              ...
              className="border-l border-evening-orange/30 pl-6 mt-4"
            >
              <p className="font-editorial italic text-sand/60 leading-relaxed"
      ...
      <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[500px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(ellipse, rgba(196,112,42,0.035) 0%, transparent 70%)' }} />
    </section>
  )
}
